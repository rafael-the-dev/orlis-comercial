...
const mongoDBConnection = new MongoClient("mongodb+srv://rafael-the-dev:iH.-qJftk8g9cgc@cluster0.z64j5.mongodb.net/rt-comercial-db?authMechanism=DEFAULT");
...
const createMongoDBConnection = async () => {
    ...
    try {
        ...
        mongoDBConnection.on("connectionCreated", () => {
            ...
            clusterDB = mongoDBConnection.db("rt-comercial-db");
        ...
        console.log('Connected successfully to rt comercil mongodb server');
    } catch(err) {
       closeDbConnections();
        throw err;
    }
